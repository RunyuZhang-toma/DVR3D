...
subroutine basis(rbasis,q,dnorm,A,idim,maxfn,npts)
    ...
    double precision :: a, alpha, amx, afnm1, bin, count, fn, rbasis(0:idim,npts),q(npts),dnorm(0:maxfn)
...
subroutine getbas(basise,basiso,reo,q,wt,b,c,dnorme,dnormo,maxq)
    ...
    double precision :: toler=1d-8, csxe, csae, tsxe, csxo, csao,tsxo, tsae, factor, prefac tsao
