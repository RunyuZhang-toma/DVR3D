...
!  by GJH & JT 2001.
    ...
    integer :: itra,ilev, ispe, item,jmax,irate2,imax2,j,maxr,nr,nmax1,nmax2,j1,j2,kmin1,kmin2,neval1,neval2,idia,ipar,isym,max,ie2,ipar1,ie1
    double precision :: wsmax,wsmin, emin, emax, smin, gz,wsmi,wsma,emi,ema,smi,ee,w
