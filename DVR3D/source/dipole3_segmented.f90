module dipole3_seg_logic
      ...
      logical :: zmors2 = .true.
end module dipole3_seg_logic

module dipole3_seg_stream
      integer :: iket = 11
      integer :: ibra = 12
      integer :: itra = 13
      integer :: iscr = 24
      ...
      integer :: mblock
      integer :: nblock = 1000
end module dipole3_seg_stream

module dipole3_seg_timing
      integer :: itime0
end module dipole3_seg_timing

module dipole3_seg_dim
      integer :: ncoord
      integer :: npnt
      integer :: npnt1
      integer :: npnt2
      ...
      integer :: ibase2
      integer :: ipot
end module dipole3_seg_dim

module dipole3_seg_sym
      integer :: idia
      integer :: ipar1
      integer :: ipar2
      integer :: jrot1
      integer :: jrot2
end module dipole3_seg_sym

module dipole3_seg_mass
      logical :: zembed
      logical :: zbisc
      double precision :: g1, g2, xmass(3)
end module dipole3_seg_mass
...
!
      use dipole3_seg_logic
      use dipole3_seg_stream
      use dipole3_seg_timing
