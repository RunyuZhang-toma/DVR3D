...
module dipole3_rme_logic
    ...
    logical :: zpseg  = .false.   
end module dipole3_rme_logic

module dipole3_rme_stream
...
end module dipole3_rme_stream

module dipole3_rme_timing
      integer :: itime0
end module dipole3_rme_timing

module dipole3_rme_dim
    ...
    integer :: ipot
end module dipole3_rme_dim

module dipole3_rme_sym
    ...
    integer :: jrot1
    integer :: jrot2
end module dipole3_rme_sym

module dipole3_rme_mass
...
!
    use dipole3_rme_logic
    use dipole3_rme_stream
    use dipole3_rme_timing
...
2     continue
    ...
    deallocate(lbass)
    return
999   write(6,"(//,5x,'basis function dimensions in error',&
             /,5x,'unit =',i3,' mbass =',i7,' expected, =',i7,' found')") ivec,mbass,mbass0
...
10    continue
 ...
 1000 format(//,i8,' point gauss-associated legendre integration',&
             ...
             /,(f23.15,d25.12))
    write(6,"(a100,d26.15,a100,d26.15//)") 'computed sum of weights',csa,'exact    sum of weights',tsa
...
201   format(//,5x,'*************************************************'&
    ...
    write(6,"(5x,9a8)") title
    write(6,"(///)")
    write(6,"(a10,i4,a10,i4,a10,i4,a10,i4,a10,i4,a10,i4,a10,i4,//)")'j1=', j1, '  kmin1=',kmin1,'  j2=', j2,'  kmin2=', kmin2,&
      & '  idia=',idia, '  ipar1=',ipar1,'  ipar2=', ipar2
...
subroutine rme1output(tz1,tx1,e1,e2,sint,xe2)
    ...
    if (.not.zbisc .and. zembed) txd = -txd
    if (zpmin .and. max(ie1,ie2)>10) goto 2
    write(14,"(6(i2,1x),2(i5,1x),3(f10.4,3x),2(f13.10,3x))") jrot1,jrot2,kmin1,kmin2,ipar1,ipar2,ie1,ie2,xe1,xe2(ie2),abs((xe2(ie2)-xe1)),tz1(ie1,ie2),tx1(ie1,ie2)
...
subroutine rme2output(tz1,tx1,tx2,e1,e2,sint,xe2)
    ...
    if (.not.zbisc .and. zembed) txd = -txd
    if (zpmin .and. max(ie1,ie2)>10) goto 2
    write(15,"(6(i2,1x),2(i5,1x),3(f10.4,3x),3(f13.10,3x))") jrot1,jrot2,kmin1,kmin2,ipar1,ipar2,ie1,ie2,xe1,xe2(ie2),abs((xe2(ie2)-xe1)),tz1(ie1,ie2),tx1(ie1,ie2),tx2(ie1,ie2)
