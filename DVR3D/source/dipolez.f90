  ...
  ! loop over the BRA k blocks
    do j=1,nk1
        ...
        do k=1,nk2 
                ...
                write(6,"(' sdip ',I2,2X,I2,2X,I2,2X,I2,2X,D25.18)")kz1,kz2,iqpar1,iqpar2,sa
...
subroutine commongrid
    ...
    do i=1,nth
    write(6,"(I4,2(2x,d20.13))")i,thgrid(i),wt(i)
    end do
    end if
...
subroutine spect
  ...
  ! pb also worked on it
    ...
    write(6,"(///)")
    write(6,"(5x,'  jrot1=',i4,'  jrot2=',i4,&
            '  ifpar1=',i4,'  ifpar2=',i4,//)") jrot1, jrot2, ifpar1, ifpar2
    write(6,"(5x,'ground zero =',e16.8,' cm-1')") ezero
    
    write(6,"(///)")
    write(6,"(/,a100, a100 ,/)")' ie1 ie2   ket energy   bra energy    frequency',&
            &'       s(f-i)      a-coefficient'
    ...
    do 1 ie1=1,nv1
        ...
        do 2 ie2=1,nv2
            ...
            write(6,"(2(i4),3(3x,f10.3),(2x,e13.6),(2x,f13.6))") ie1+ibase1,ie2+ibase2,xe1,xe2,dd,sxd,a 
            write(96,"(2(i4),3(3x,f12.5),f16.8)") ie1+ibase1,ie2+ibase2,xe1,xe2,dd,a 
    2       continue
    !        if (.not.zpmin .or. ie1<=10) write(6,"(//)")
    !        if (ie1<=nval1) write(6,"(//)")
            write(6,"(//)")
    1       continue
