...
subroutine read_26_radau
  use size
  implicit none
  integer :: I,IANG2,IBASS2,MEVAL2,LABEL,KA,KC,NU3,KC1,KC2,J
  LOGICAL :: ZEMBED,ZMORS1,ZNCOR,ZQUAD2
  DOUBLE PRECISION :: XMASS,G1,G2,XM,RE1,DISS1,WE1,P1,P2
...
subroutine read_8or9_radau
  use size
  implicit none
  LOGICAL :: ZEMBED,ZMORS1,ZMORS2,ZNCOR,ZMORSE1,ZMORSE2
  DOUBLE PRECISION :: XM,G1,G2,RE2,DISS2,WE2
  INTEGER :: MBASS0,I,L,K,J,LABEL
